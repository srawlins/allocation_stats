...
It is very simple to pass a block to `ObjectSpace::Stats.new` and print out a
listing of all of the object allocations that occurred within the block:
...
Ruby 2.1 Feature: `#trace_object_allocations`
=============================================
...
following for any new object allocation:
